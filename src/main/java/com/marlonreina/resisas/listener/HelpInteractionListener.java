...
public class HelpInteractionListener extends ListenerAdapter {
    ...
    public void onStringSelectInteraction(StringSelectInteractionEvent event) {
        if (!event.getComponentId().equals("help:select")) return;

        String selected = event.getValues().get(0); // ej: "help:cmd:vmatch"
        if (!selected.startsWith("help:cmd:")) return;
    ...
    public void onButtonInteraction(ButtonInteractionEvent event) {
        if (!event.getComponentId().equals("help:back")) return;
        ...
        embed.setFooter("Resisas Bot  •  " + guildName);
    ...
    private EmbedBuilder buildCommandEmbed(String cmd, String prefix,
        ...
        switch (cmd) {
            case "ping" -> {
                ...
                embed.addField("📌 Uso",      "`" + prefix + "ping`", false);
                embed.addField("📋 Ejemplo",  "`" + prefix + "ping`", false);
            ...
            case "prefix" -> {
                ...
                embed.addField("📌 Uso",      "`" + prefix + "prefix <nuevo>`", false);
                embed.addField("📋 Ejemplo",  "`" + prefix + "prefix !`",       false);
            ...
            case "help" -> {
                ...
                embed.addField("📌 Uso",      "`" + prefix + "help`", false);
                embed.addField("🔒 Permisos", "Ninguno",               false);
            }
            case "clear" -> {
                embed.setTitle("🛡️  clear");
                embed.setDescription("Elimina una cantidad de mensajes del canal.");
                embed.addField("📌 Uso",      "`" + prefix + "clear <cantidad>`",   false);
                embed.addField("📋 Ejemplo",  "`" + prefix + "clear 10`",           false);
            ...
            case "kick" -> {
                ...
                embed.addField("📌 Uso",      "`" + prefix + "kick <@usuario> [razón]`", false);
                embed.addField("📋 Ejemplo",  "`" + prefix + "kick @user spam`",         false);
            ...
            case "ban" -> {
                ...
                embed.addField("📌 Uso",      "`" + prefix + "ban <@usuario> [razón]`",        false);
                embed.addField("📋 Ejemplo",  "`" + prefix + "ban @user conducta inapropiada`", false);
            ...
            case "consultar" -> {
                ...
                embed.addField("📌 Uso",      "`" + prefix + "consultar <nombre#tag>`", false);
                embed.addField("📋 Ejemplo",  "`" + prefix + "consultar Neon#RS シ`",  false);
            ...
            case "vrank" -> {
                ...
                embed.addField("📌 Uso",      "`" + prefix + "vrank <nombre#tag>`",         false);
                embed.addField("📋 Ejemplo",  "`" + prefix + "vrank Neon#RS シ`",           false);
            ...
            case "vmatch" -> {
                ...
                embed.addField("📌 Uso",     "`" + prefix + "vmatch <nombre#tag>`", false);
                embed.addField("📋 Ejemplo", "`" + prefix + "vmatch Neon#RS シ`",  false);
